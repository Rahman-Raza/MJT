...
class SubmitPageJD extends React.Component {
    ...
    return (
      ...
      <MuiThemeProvider muiTheme={muiTheme}>
           ...
           <Section containerSize={100}>
            ...
            <Section containerSize={"100%"} style={{background: "url(" + Background + ") no-repeat",
          ...
          <Section containerSize={"80%"} style={{marginTop: "10%", marginBottom: "10%"}} >
            <h2>Thank you for your submission. </h2>
          </Section>
          <Section className="animated" data-animation="fadeInLeft" data-animation-delay="400" containerSize={"80%"} style={{marginTop: "15%", marginBottom: "15%"}} >
...
const connectedSubmitPageJD = connect(mapStateToProps)(SubmitPageJD);
export  { connectedSubmitPageJD as SubmitPageJD };
